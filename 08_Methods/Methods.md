...
Complete genomes of *Mycobacterium tuberculosis* belonging to
...
The H37Rv PPE18 protein sequence was used as the query for NCBI BLASTP.

The search was restricted to *Mycobacterium tuberculosis*
(taxid: 1773).
...
The specific distance model and additional phylogenetic parameters
were not documented in the original analysis.
...
The predicted PPE18 structure was evaluated using Ramachandran plot
analysis.
